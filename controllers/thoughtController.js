      ...
      .then((data) =>
        !data
          ? res
              ...
              .json({
                message:
                  "Thought was created but there is no user associated with the given id",
              })
      ...
      .then((data) =>
        !data
          ? res
              .status(404)
              .json({
                message: "There is no thought associated with the given id",
              })
      ...
      .then((data) =>
        !data
          ? res
              ...
              .json({
                message:
                  " Thought deleted but there is no user associated with the given id",
              })
